...
salt = b'supersecretssalt'   # byte-object
...
def run_dns_server():
    # UDP socket bound to loopback on standard DNS port 53
    ...
    while True:
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                # Skeleton-style: append RRset then add rdata to it
            ...
            # Set the response flags (AA - Authoritative Answer bit)
            response.flags |= 1 << 10
